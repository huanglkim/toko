            ...
            <div class="card col-md-12">
                <div class="mb-4">
                    <h2 class="text-primary">
                        <i class="fas fa-shopping-basket mr-2"></i> DAFTAR GUDANG
                    </h2>
                    <div class="card">
                        <div class="card-body pb-1 pt-1">
                            <div class="d-flex flex-wrap gap-2 justify-content-end mb-3">
                                <button type="button" onclick="addForm()" class="btn btn-outline-primary btn-sm">
                                    <i class="fas fa-plus-square me-1"></i> Tambah Gudang
                                </button>
                            </div>
...
@section('script')
    ...
    <script type="text/javascript">
        ...
        function AddOrEdit() { //tambah atau edit //store update
            if (reqsent == false) {
                reqsent = true;
                var id = $('#id').val();
                if (save_method == 'POST') url = "{{ url('gudang') }}";
    ...
    <script type="text/javascript">
        ...
        function datatable() {
            ...
            var urlget = "{{ url('/tabelgudang') }}" + "/" + deleted;
