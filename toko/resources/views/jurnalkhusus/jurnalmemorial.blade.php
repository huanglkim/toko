                                ...
                                <div class="col-lg-6">
                                    <div class="form-row">
                                        ...
                                        <div class="col-sm-8">
                                            ...
                                            <input type="hidden" id="tipe" name="tipe" value="JM">
                                    ...
                                    <div class="form-row">
                                        <label for="kode_acc" class="col-sm-4 col-form-label">KREDIT:</label>
                                        <div class="col-sm-8">
                                    ...
                                    <div class="form-row">
                                        <label for="kode_lawan" class="col-sm-4 col-form-label">DEBIT:</label>
                                        <div class="col-sm-8">
