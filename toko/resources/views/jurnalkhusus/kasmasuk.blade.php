                                ...
                                <div class="col-lg-6">
                                    <div class="form-row">
                                        ...
                                        <div class="col-sm-8">
                                            ...
                                            <input type="hidden" id="tipe" name="tipe" value="KM">
                                            <input type="hidden" id="posisi" name="posisi" value="D">
                                    ...
                                    <div class="form-row">
                                        <label for="kode_acc" class="col-sm-4 col-form-label">Masuk KE</label>
                                        <div class="col-sm-8">
                                    ...
                                    <div class="form-row">
                                        <label for="kode_lawan" class="col-sm-4 col-form-label">Dari</label>
                                        <div class="col-sm-8">
                                            <select class="form-control form-control-sm selectpicker" name="kode_lawan"
                                                id="kode_lawan" data-live-search="true">
    ...
    <script type="text/javascript">
        function AddOrEdit() {
            if (reqsent == false) {
                ...
                var data = $('#form-kasmasuk').serialize() + "&_method=" + method;
                $.ajax({
                    url: url,
                    timeout: 2500,
                    method: "POST",
                    ...
                    success: function(data) {
                        document.getElementById("form-kasmasuk").reset();
                        reqsent = false;
                        if (data.success == 1) {
                            Swal.fire({
                                position: 'top-end',
