    ...
    <div class="container py-4">
        <div class="card mb-4">
            <div class="card-header d-flex justify-content-between align-items-center">
                <h3 class="mb-0">Laporan Penjurnalan</h3>
            </div>
            <div class="card-body">
                <form id="filter-form" action="{{ url('') }}/laporan-penjurnalan/print" method="POST">
                    @csrf
                    <div class="row g-3 align-items-end">
                        ...
                        <div class="col-lg-3">
                            ...
                            <select name="tipe" id="tipe" class="form-control form-control-select">
                                <option value="cetak">Cetak</option>
                                <option value="excel">Download Excel</option>
                            </select>
                        </div>
                        <div class="col-md-3 d-grid">
                            <button type="submit" id="print-btn" class="btn btn-success">
