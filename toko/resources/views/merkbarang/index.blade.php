            ...
            <div class="card col-md-12">
                <div class="mb-4">
                    <h2 class="text-primary">
                        <i class="	fas fa-building mr-2"></i> DAFTAR MERK BARANG
                    </h2>
                    <div class="card">
                        <div class="card-body pb-1 pt-1">
                            <div class="d-flex flex-wrap gap-2 justify-content-end mb-3">
                                <button type="button" onclick="addForm()" class="btn btn-outline-primary btn-sm">
                                    <i class="fas fa-plus-square me-1"></i> Tambah Merk Barang
                                </button>
                            </div>
...
@section('script')
    ...
    <script type="text/javascript">
        function addForm() { //form tambah show
            ...
            $('.modal-title').text('Tambah Merk Barang');
        }
            ...
            $.ajax({
                ...
                success: function(data) {
                    if (data.success == 1) {
                        ...
                        $('#id').val(data.id);
                        $('#nama_merkbarang').val(data.nama_merkbarang);
                    }
                    if (data.success == 0) {
    ...
    <script type="text/javascript">
        ...
        function datatable() {
            ...
            var urlget = "{{ url('/tabelmerkbarang') }}" + "/" + deleted;
            ...
            $('#tabel_data').DataTable({
                ...
                columns: [{
                        data: 'nama_merkbarang',
                        name: 'nama_merkbarang'
                    },
