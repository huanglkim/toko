<div class="modal fade" id="modal-form-pelanggan" tabindex="1" role="dialog" aria-hidden="true" data-backdrop="static">
    <div class="modal-dialog">
        <div class="modal-content">
            <form id="form-pelanggan" method="post" class="form-horizontal" data-toggle="validator"
                ...
                <div class="modal-body">
                    ...
                    <div class="box-body">
                        <div class="form-group">
                            <div class="form-row">
                                <label for="kode" class="col-sm-4 col-form-label">Kode Pelanggan</label>
                                <div class="col-sm-8">
                        ...
                        <div class="form-row">
                            ...
                            <div class="col-sm-8">
                                {!! Form::select('group', ['1' => 'Reguler', '2' => 'Premium'], '1', [
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-outline-default pull-left" data-dismiss="modal">Cancel</button>
                    <button type="button" class="btn btn-outline-primary" id="AddOrEditForm"
                        onclick="AddOrEditpel()">Simpan</button>
                </div>
...
<!-- /.modal -->
<script>
    function formpelanggan() { //form tambah show
        save_method = "POST";
    ...
    function AddOrEditpel() { //tambah atau edit //store update
        if (reqsent == false) {
            reqsent = true;
            var id = $('#id').val();
            if (save_method == 'POST') url = "{{ url('pelanggan') }}";
    ...
    function ubahtitle(nama_pel) {
        var selectpicker = $("#pelanggan_id");
