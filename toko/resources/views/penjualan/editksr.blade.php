    ...
    <section class="content">
        <div class="card col-md-12">
            <div class="card-header">
                <h3 class="card-title">Tambah Penjualan Tunai</h3>
            </div>
            <form id="form-datapj" class="card-body">
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-md-4 col-lg-3">
                        <input data-column="tanggal" onchange="fastupdate(this)" data-id="{{ $pjhd->id }}"
                ...
                <div class="row mb-3">
                    <div class="col-md-2 col-lg-2">
                        <label for="pelanggan_id" class="col-form-label font-weight-bold">Pelanggan:</label>
                    </div>
                    <div class="col-md-7 col-lg-6" id="caripelanggan">
                        <select data-column="pelanggan_id" onchange="fastupdate(this)" data-id="{{ $pjhd->id }}"
                            class="form-control selectpicker" id="pelanggan_id" name="pelanggan_id" data-size="7"
                            data-live-search="true" data-title="
                    ...
                    <div class="col-md-3 col-lg-3">
                        <button onclick="formpelanggan()" type="button"
                            class="btn btn-sm btn-outline-primary color-palette btn-flat w-100">
                            <i class="fas fa-plus-square"></i> Pelanggan Baru
                        </button>
                    </div>
                </div>
            </form>
...
@section('script')
    ...
    <script>
        ...
        function footerpj() {
            var geturl = base_url + '/footerksr/' + pjhd_id;
            $.ajax({
                url: geturl,
                method: "POST",
                data: {
