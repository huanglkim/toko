<div class="modal fade" id="cartModalpj" tabindex="-1" role="dialog" aria-labelledby="cartlModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <form id="form-cartpj" method="post" class="form-horizontal" data-toggle="validator">
                @csrf @method('POST')
                        ...
                        <div class="form-row">
                            ...
                            <div class="col-sm-6">
                                <input type="text" class="form-control form-control-sm" id="qty" name="qty"
                                    ...
                                    onkeyup="hitungtotal_harga()" autocomplete="off">
                            </div>
                        </div>
                        <div class="form-row">
                            <div class="col-sm-5">
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-primary" id="btn-simpan-cart"
                    onclick="UpdateCartBarang()">[Update] SIMPAN</button>
            </div>
        </div>
    </div>
</div>
