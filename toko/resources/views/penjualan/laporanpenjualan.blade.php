...
@section('content')
    <div class="container py-4">
        <div class="card mb-4">
            ...
            <div class="card-body">
                <form id="filter-form" action="{{ url('') }}/laporan-penjualan/print" method="POST">
                    @csrf
                    <div class="row g-3 align-items-end">
                        ...
                        <div class="col-md-2">
                            <label for="pelanggan_id" class="form-label">Filter Pelanggan:</label>
                            <select class="form-control selectpicker w-100" name="pelanggan_id" id="pelanggan_id"
                                    data-live-search="true" data-placeholder="Pilih pelanggan">
                        ...
                        <div class="col-md-2">
                            ...
                            <select class="form-control selectpicker w-100" name="jenis" id="jenis">
                                <option value="rekap">
                                    rekap</option>
                                <option value="detail">
                                    detail</option>
