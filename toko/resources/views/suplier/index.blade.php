...
@section('content')
            ...
            <div class="card col-md-12">
                <div class="mb-4">
                    <h2 class="text-primary">
                        <i class="fas fa-truck mr-2"></i> DAFTAR SUPLIER
                    </h2>
                    <div class="card">
                        <div class="card-body pb-1 pt-1">
                            <div class="d-flex flex-wrap gap-2 justify-content-end mb-3">
                                <button type="button" onclick="addForm()" class="btn btn-outline-primary btn-sm">
                                    <i class="fas fa-plus-square me-1"></i> Tambah Suplier
                                </button>
                            </div>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-4">
                                    <div class="callout-panel">
                                        <h6 class="callout-panel-title">Group N/P</h6>
                                        <select class="custom-select custom-select-sm"
    ...
    {{-- Modal Otoritas Login (bila dibutuhkan) --}}
...
@section('script')
    ...
    <script type="text/javascript">
        $('#modal-form-suplier').on('shown.bs.modal', function() {
            $('#kode').focus();
        });
        ...
        function AddOrEditsup() { //tambah atau edit //store update
            if (reqsent == false) {
                reqsent = true;
                var id = $('#id').val();
                if (save_method == 'POST') url = "{{ url('suplier') }}";
                else url = "{{ url('suplier') . '/' }}" + id;
        ...
        function OtEdit(id) {
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    if (data.success == 0) {
                        $('#modal-form-supplier').modal('hide');
                        Swal.fire({
                            position: 'top-end',
                            title: data.pesan,
                            icon: 'error',
    ...
    <script type="text/javascript">
        ...
        function datatable() {
            ...
            var urlget = "{{ url('/tabelsuplier') }}" + "/" + group + "/" + status + "/" + deleted;
